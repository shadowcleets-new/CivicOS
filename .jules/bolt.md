...
## 2024-07-16 - Explicit composite index for keyset pagination
...
**Action:** When implementing keyset pagination, always create a composite index that matches the exact column order and sort direction used in the query.
