...
## 2024-10-24 - Keyset Pagination Optimization
...
**Action:** Always add a composite index matching the `ORDER BY` clause when implementing keyset pagination to avoid full table scans.
