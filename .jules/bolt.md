...
**Action:** Always add explicit composite indexes (e.g., Index('idx_name', col1.desc(), col2.desc())) in the SQLAlchemy model's __table_args__ when implementing keyset pagination.
