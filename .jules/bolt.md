...
## 2024-05-28 - Composite Indexes for Keyset Pagination
...
**Action:** Always verify that a corresponding composite `Index` is defined in `__table_args__` when implementing keyset pagination to prevent full table sorts.
