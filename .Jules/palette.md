...
## 2024-08-10 - Explicit Feedback for Unimplemented Features
**Learning:** Stubbed buttons with empty callbacks (silent failures) lead to user confusion as they might think the app is frozen or their input didn't register.
**Action:** When a feature is not yet fully implemented, always provide explicit, transparent messaging (like a SnackBar or Toast) stating 'Feature coming soon' instead of failing silently.
