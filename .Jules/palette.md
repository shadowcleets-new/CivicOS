...
## 2024-06-07 - Transparent Feedback for Stubbed Buttons
**Learning:** Providing fake success messages or no feedback for unimplemented features creates deceptive UI states and poor UX.
**Action:** Always use transparent messaging like 'Feature coming soon' (e.g., via SnackBar) when stubbing button actions.
