...
## 2024-05-24 - Explicit Messaging for Stubbed Features
**Learning:** Stubbed buttons or unimplemented features with empty callbacks leave users confused when there is no visual feedback. Sighted and screen-reader users need explicit messaging when a feature is not yet available.
**Action:** Add explicit, transparent messaging like a 'Feature coming soon' SnackBar or Toast to stubbed buttons instead of leaving a silent failure.
