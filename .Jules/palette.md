...
## 2026-07-21 - Explicit Feedback for Stubbed Buttons
**Learning:** Users can experience confusion when interacting with stubbed features that fail silently (e.g. empty onPressed callbacks). Adding explicit messaging ensures transparent feedback.
**Action:** Always provide visual or textual feedback like a SnackBar for upcoming or stubbed features instead of leaving empty callbacks.
