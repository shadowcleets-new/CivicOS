...
## 2026-08-09 - Transparent Feedback for Unimplemented Features
**Learning:** Silent failures on unimplemented or stubbed features (like empty `onPressed` callbacks) confuse users, leading them to think the app is broken or frozen.
**Action:** Always provide explicit, transparent messaging (e.g., a "Feature coming soon" SnackBar or Toast) when a feature is not yet available, ensuring users receive immediate feedback upon interaction.
