...
## 2026-07-15 - Transparent Feedback for Stubbed Actions
**Learning:** Silent failures on unimplemented features (like empty `onPressed` handlers in prototypes) confuse users, making them think the app is broken rather than incomplete.
**Action:** Always provide explicit, transparent messaging (e.g., a "Feature coming soon" SnackBar) for stubbed actions to set correct expectations.
