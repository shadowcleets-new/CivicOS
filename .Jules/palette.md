...
## 2024-08-29 - Stubbed Features Need Explicit Feedback
**Learning:** When encountering stubbed buttons or unimplemented features (e.g., empty onPressed callbacks), leaving them as silent failures causes user confusion and frustration. Users may think the app is broken or their tap didn't register.
**Action:** Add explicit, transparent messaging like a 'Feature coming soon' SnackBar or Toast to stubbed interactions instead of leaving them empty.
