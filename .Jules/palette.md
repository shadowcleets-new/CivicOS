...
## 2024-10-24 - Transparent Feedback for Stubbed Features
**Learning:** Users often get confused and think an app is broken when buttons fail silently (like empty onPressed callbacks during prototyping). Providing explicit feedback for unimplemented features prevents user frustration and builds trust.
**Action:** When adding UX feedback to stubbed buttons or unimplemented features, always provide explicit, transparent messaging (e.g., a "Feature coming soon" SnackBar) instead of allowing silent failures or creating fake success messages.
