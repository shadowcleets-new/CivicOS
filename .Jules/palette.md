...
## 2024-07-18 - Transparent Feedback for Stubbed Features
**Learning:** Silent failures on unimplemented or stubbed buttons cause user confusion, making them wonder if the app is broken or their tap didn't register.
**Action:** Always provide explicit, transparent messaging (like a 'Feature coming soon' SnackBar) for stubbed features instead of leaving empty callbacks.
