...
## 2024-05-24 - Explicit Feedback for Stubbed Features
**Learning:** Silent failures on unimplemented features (like empty `onPressed` callbacks) cause significant user confusion and frustration. Users often think the app is broken rather than incomplete.
**Action:** Always provide explicit, transparent messaging (e.g., a 'Feature coming soon' SnackBar) for any stubbed interactive element instead of leaving it completely silent.
