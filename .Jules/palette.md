...
## 2026-07-08 - Transparent Messaging for Stubbed Features
**Learning:** Empty `onPressed` callbacks create silent failures, leaving users confused about whether their action registered or the app is broken.
**Action:** When stubbing out buttons or features that are not yet implemented, always provide explicit, transparent messaging (like a 'Feature coming soon' SnackBar) instead of silent failures.
