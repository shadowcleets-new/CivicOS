...
## 2024-08-14 - Prevent Silent Failures on Unimplemented Actions
**Learning:** Unimplemented features or stubbed callbacks (like empty `onPressed` functions) create a frustrating user experience when tapped, as they provide no feedback. This violates the heuristic of system status visibility.
**Action:** Always provide explicit, transparent messaging like a 'Feature coming soon' SnackBar or Toast instead of failing silently on stubbed interactions.
