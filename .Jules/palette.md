...
## 2024-09-08 - Explicit Messaging for Stubbed Features
**Learning:** Leaving buttons unimplemented with empty callbacks causes silent failures, confusing users and degrading trust.
**Action:** When encountering stubbed buttons, add explicit, transparent messaging like a "Feature coming soon" SnackBar or Toast.
