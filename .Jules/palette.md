...
## 2024-08-02 - Explicit Feedback for Stubbed Actions
**Learning:** Silent failures from stubbed buttons with empty callbacks cause user confusion and make the app feel broken.
**Action:** When adding UX feedback to stubbed buttons or unimplemented features, always provide explicit, transparent messaging like a 'Feature coming soon' SnackBar instead of leaving callbacks empty.
