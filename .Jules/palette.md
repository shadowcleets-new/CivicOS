...
## 2024-11-20 - Transparent Feedback for Stubbed Features
**Learning:** Silent failures on unimplemented features (like empty `onPressed` callbacks) cause significant user frustration and confusion, leading them to think the app is broken.
**Action:** Always provide explicit, transparent messaging (e.g., a "Feature coming soon" SnackBar) for stubbed buttons to manage user expectations gracefully.
