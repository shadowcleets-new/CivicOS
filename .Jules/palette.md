...
## 2024-05-24 - Transparent messaging for unimplemented features
**Learning:** Users can become confused when stubbed UI elements fail silently or show deceptive states. Providing clear feedback for unimplemented features improves UX by managing expectations.
**Action:** When adding UX feedback to stubbed buttons or unimplemented features with empty `onPressed` callbacks, use transparent messaging like 'Feature coming soon'.
