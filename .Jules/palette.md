...
**Learning:** Silent failures on interactive elements cause confusion and poor UX. When a feature is unimplemented or stubbed, users may repeatedly tap it or assume the app is broken.
**Action:** Always provide explicit, transparent messaging like a 'Feature coming soon' SnackBar or Toast for stubbed buttons instead of leaving the callback empty.
