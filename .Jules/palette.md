...
## 2024-07-23 - Transparent Feedback for Stubbed Features
**Learning:** Silent failures on unimplemented buttons leave users confused, wondering if the app is broken or if their input didn't register.
**Action:** Always provide explicit, transparent messaging (like a "Feature coming soon" SnackBar) for stubbed buttons or incomplete features to manage user expectations.
