...
## 2024-07-14 - Explicit Feedback for Unimplemented Features
**Learning:** Empty callbacks on buttons or features lead to silent failures, making users think the application is broken or their input didn't register.
**Action:** When implementing placeholder buttons for future features, always provide clear, explicit feedback (like a "Feature coming soon" SnackBar) instead of leaving silent failures or showing fake success messages.
