...
## 2024-05-14 - Explicit Feedback for Stubbed Features
**Learning:** Silent failures on unimplemented buttons (like a camera capture) cause user confusion, especially in prototypes.
**Action:** Always add explicit, transparent messaging like a 'Feature coming soon' SnackBar instead of leaving an empty callback.
