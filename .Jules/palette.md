...
## 2026-09-07 - [Transparent Feedback for Stubbed Features]
**Learning:** Empty callbacks on stubbed buttons create a confusing experience where users think the app is broken or unresponsive. A micro-UX improvement is to add explicit, transparent messaging like a 'Feature coming soon' SnackBar instead of leaving a silent failure.
**Action:** Always provide visual feedback (e.g. Snackbars, Toasts) on unimplemented or stubbed UI components so the user knows their interaction was registered.
