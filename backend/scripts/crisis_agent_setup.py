...
def download_docs():
    ...
    for name, url in DOCS.items():
        ...
        try:
            ...
            # SECURE: Enforce SSL validation to prevent MITM attacks
            ...
            logger.error(f"Security error: SSL Certificate validation failed for {url}. Skipping to prevent MITM attack: {e}")
