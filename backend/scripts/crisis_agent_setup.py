...
def download_docs():
    ...
    for name, url in DOCS.items():
        ...
        try:
            ...
            # Security Fix: Removed verify=False to prevent MITM attacks. If cert fails, fail securely.
            ...
            logger.error(f"SSL Certificate validation failed for {name} ({url}). Skipping download to prevent MITM attack: {e}")
            continue
