...
def download_docs():
    ...
    for name, url in DOCS.items():
        ...
        try:
            ...
            # Sentinel: Enforce SSL verification to prevent MITM attacks. Log and skip on SSLError.
            ...
            logger.error(f"SSL Certificate Error for {name}. Skipping download to prevent MITM attack: {e}")
