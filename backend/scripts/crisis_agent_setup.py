...
def download_docs():
    ...
    for name, url in DOCS.items():
        ...
        try:
            ...
            # Enforce strict SSL validation (verify=True is default). Do not fallback on SSLError to prevent downgrade attacks.
            ...
            logger.error(f"SSL validation failed for {name}. Skipping to prevent MitM downgrade attacks: {e}")
