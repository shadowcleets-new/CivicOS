...
class Grievance(Base):
    ...
    # Add a composite index to fully optimize the keyset pagination queries
    # which sort by (created_at DESC, id DESC).
    __table_args__ = (
        Index('ix_grievance_created_at_id_desc', text('created_at DESC'), text('id DESC')),
    )
