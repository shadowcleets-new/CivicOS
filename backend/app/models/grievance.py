...
class Grievance(Base):
    ...
    # Optimization: Composite index for keyset pagination on created_at and id.
    # Impact: Significantly speeds up queries sorting by created_at DESC, id DESC
    # by allowing O(1) index lookup instead of sequential scan and sort.
    __table_args__ = (
        Index('idx_grievance_pagination', created_at.desc(), id.desc()),
    )
