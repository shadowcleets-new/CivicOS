...
class Grievance(Base):
    ...
    # Bolt Optimization: Added index=True to created_at to optimize keyset/cursor pagination queries.
    # This prevents full table scans when sorting by created_at descending.
