...
class Grievance(Base):
    ...
    # The read_grievances endpoint uses keyset pagination sorting by created_at.desc(), id.desc().
    # Indexing this column avoids an expensive O(N log N) full table sort for the public feed.
