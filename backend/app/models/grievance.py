...
class Grievance(Base):
    ...
    # Composite index matching the pagination ORDER BY clause
    # to enable fast keyset pagination without full table scans
    __table_args__ = (
        Index('idx_grievances_pagination', created_at.desc(), id.desc()),
    )
