...
class Grievance(Base):
    ...
    # BOLT OPTIMIZATION: Added index=True to created_at to optimize keyset pagination sorting
    # This prevents full table scans when ordering by created_at.desc() in read_grievances
