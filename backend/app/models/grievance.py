...
class Grievance(Base):
    ...
    # ⚡ Bolt Optimization: Added index=True to created_at to support efficient keyset/cursor pagination.
    # This prevents full table scans and O(N log N) in-memory sorts on large datasets, turning the sort into an O(log N) index lookup.
