...
class Grievance(Base):
    ...
    # BOLT OPTIMIZATION: Added index=True to created_at to optimize keyset pagination
    # and feed sorting, reducing chronological queries from O(N) full table scans to O(log N).
