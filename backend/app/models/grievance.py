...
class Grievance(Base):
    ...
    # ⚡ Bolt Optimization: Composite index to optimize keyset pagination
    # ordering by created_at DESC and id DESC. Reduces query from O(N log N) sort to O(log N) index scan.
    __table_args__ = (
